  ...
  return (
    <div className='relative mx-5 rounded-3xl bg-[#E3F0FF] p-5 sm:mx-auto sm:w-fit md:mx-auto md:w-fit lg:w-fit'>
      <div className='group relative overflow-hidden rounded-3xl bg-white'>
        ...
        />
        <div className='absolute inset-0 mx-auto mt-[40%] flex size-fit items-center  justify-center rounded-full bg-[#0044EB] bg-opacity-0 p-16 transition-all duration-300 ease-linear group-hover:bg-opacity-100'>
