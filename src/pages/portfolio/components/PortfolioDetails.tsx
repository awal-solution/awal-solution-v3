  ...
  return (
    <>
      <HeroSection
        ...
        subHeading={
          'Techco/Technology/Driving Digital Transformation Explore the Depth of Our IT Projects'
        }
      />
        ...
        <div>
          <div className='pt-5 lg:pt-24  '>
            <img
              ...
              src={
                'https://wp.xpressbuddy.com/techco/wp-content/uploads/2024/05/portfolio_details_image_1-scaled.webp'
              }
              alt={' '}
            />
          </div>
