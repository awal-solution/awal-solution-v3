...
const BlogPost = () => (
  <div className='mt-[300px] rounded-2xl bg-white p-7'>
    <div className='overflow-hidden'>
      <img
        className='overflow-hidden duration-300 ease-linear hover:scale-110'
    ...
    <p className='py-9 font-serif text-lg font-medium tracking-wide text-[#49515B]'>
      ...
      distinguished thought leaders. With years of experience and a deep
      understanding of industry trends, our thought leaders offer invaluable
      perspectives that illuminate the path to technological excellence. From
      emerging technologies to innovative strategies, they provide unique
...
const PostMeta = () => (
  <div className=' flex gap-6 py-5'>
    <div className='items-center35 flex gap-2'>
      <div>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='1em'
